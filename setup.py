...
setup (
	...
	long_description = """
							...
							Given a list of unique numbers, the LIS function outputs all LIS from list i.e. the longest increasing subsequences having the maximum length among all results. To implement, type "from longest_increasing_subsequence import LIS" then try "LIS([2,5,1,3,4])". Note that the external module list_operations is required "from list_operations import unnest".
					   """,
